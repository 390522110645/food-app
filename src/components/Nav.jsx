...
function Nav() {
    ...
    let {input,setInput,setSearch,setShowCart}=useContext(dataContext)
    useEffect(()=>{
    ...
    return (
        <div className='w-full h-[100px] flex justify-between items-center px-5  md:px-8'>
            ...
            <div className='w-[60px] h-[60px] bg-white flex justify-center items-center rounded-md shadow-xl hover:bg-blue-200 cursor-pointer' onClick={()=>{setShowCart(true)}}><HiOutlineShoppingBag  className='h-[30px] w-[30px]  text-blue-400'/><span className='text-blue-500  font-bold '>{items.length}</span>
            </div>
